...
// Pseudo code: The Fibonacci sequence is the sum of each preceding ordered pair. Ex: Takes index 0 (value) + index 1(value) = fibTotal = 1. Then the fib total becomes the new starting index value and takes the fibTotal + 1 to become the new value 2 so, 1 + (1+1)= 2 and so on.. It function tells what the test should run. The expect function should give us the output
...
//   expect(fibonacciValue(fibonacciLength1)).toEqual([1, 1, 2, 3, 5, 8])
